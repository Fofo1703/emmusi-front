...
import { eliminarEstudiante, obtenerUnEstudiante } from '../../services/estudianteServices';
...
import { obtenerCursosMatriculados } from '../../services/cursosMatriculadosServices';
...
// --------------------------------------------**************************************************--------------------------------------------------------------------
    ...
    const columns = [
        ...
        {
            name: 'Acciones', minWidth: '330px',
            cell: row => (
                <div className='flex flex-row gap-2'>
                    <Link to={`/estudiantes/${row.id}/notas`}>
                        <Button size="small" variant="outlined" color="secondary" startIcon={<NotesIcon />}>Agregar Nota</Button>
                    </Link>
                    <Button
                        size="small"
                        variant="contained"
