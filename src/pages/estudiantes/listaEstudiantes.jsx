...
//   const columns = [
//     { name: 'Cédula', selector: row => row.cedula, sortable: true, wrap: true, },
//     { name: 'Nombre', selector: row => row.nombre, sortable: true, wrap: true,  },
//     { name: 'Teléfono', selector: row => row.telefono, wrap: true, style: { minWidth: '110px' } },
//     { name: 'Especialidad', selector: row => row.especialidad, wrap: true, },
//     { name: 'Subespecialidad', selector: row => row.subespecialidad, wrap: true,  },
//     {
//       name: 'Acciones',
//       cell: row => (
