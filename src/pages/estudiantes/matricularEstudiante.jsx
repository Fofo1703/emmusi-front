    ...
    <>
      ...
      <div className="h-auto flex flex-col items-center justify-center text-center mt-16 sm:mt-3 ">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-10">
          <p className="font-medium text-lg text-gray-500">Cédula: {estudiante.cedula}</p>
          <p className="font-medium text-lg text-gray-500">Estudiante: {estudiante.nombre}</p>
          <p className="font-medium text-lg text-gray-500">Teléfono: {estudiante.telefono}</p>
          <p className="font-medium text-lg text-gray-500">Especialidad: {estudiante.especialidad}</p>
          <p className="font-medium text-lg text-gray-500">Subespecialidad: {estudiante.subespecialidad}</p>
        </div>
